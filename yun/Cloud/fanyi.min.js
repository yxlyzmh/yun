...
function(e, t) {
    ...
    function a() {}
    var o, s, l = document, c = l.head || l.getElementsByTagName("head")[0] || l.documentElement, u = c.getElementsByTagName("base")[0], d = /\.css(?:\?|$)/i, f = /loaded|complete|undefined/;
...
define("newweb/common/ZeroClipboard", [], function(e, t) {
    !function(e, t) {
        "use strict";
        var n, r, i, a = e, o = a.document, s = a.navigator, l = a.setTimeout, c = a.clearTimeout, u = a.setInterval, d = a.clearInterval, f = a.getComputedStyle, p = a.encodeURIComponent, h = a.ActiveXObject, m = a.Error, g = a.Number.parseInt || a.parseInt, v = a.Number.parseFloat || a.parseFloat, y = a.Number.isNaN || a.isNaN, b = a.Date.now, x = a.Object.keys, w = a.Object.prototype.hasOwnProperty, T = a.Array.prototype.slice, _ = function() {
            var e = function(e) {
                return e
            };
        ...
        }, R = null == a.opener && (!!a.top && a != a.top || !!a.parent && a != a.parent), I = "html" === o.documentElement.nodeName, H = {
            bridge: null,
            version: "0.0.0",
            pluginType: "unknown",
            sandboxed: null,
...
define("newweb/common/form", [], function(e) {
    !function(t) {
        ...
        e.fn.formToArray = function(t, n, r) {
            ...
            if (0 === this.length)
                return i;
            var o, s = this[0], l = this.attr("id"), c = t || void 0 === s.elements ? s.getElementsByTagName("*") : s.elements;
    ...
    return function(e, t) {
        ...
        var O = e.document
          ...
          , M = function() {
            ...
            }, l = e.jQuery, c = e.$, u = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, d = /\S/, f = /^\s+/, p = /\s+$/, h = /\d/, m = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, g = /^[\],:{}\s]*$/, v = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, y = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, b = /(?:^|:|,)(?:\s*\[)+/g, x = /(webkit)[ \/]([\w.]+)/, w = /(opera)(?:.*version)?[ \/]([\w.]+)/, T = /(msie) ([\w.]+)/, _ = /(mozilla)(?:.*? rv:([\w.]+))?/, k = /-([a-z]|[0-9])/gi, C = /^-ms-/, S = function(e, t) {
                return (t + "").toUpperCase()
            }, E = L.userAgent, j = Object.prototype.toString, N = Object.prototype.hasOwnProperty, A = Array.prototype.push, D = Array.prototype.slice, F = String.prototype.trim, M = Array.prototype.indexOf, q = {};
        ...
        M.extend({
            Deferred: function(e) {
                var t, n = M.Callbacks("once memory"), r = M.Callbacks("once memory"), i = M.Callbacks("memory"), a = "pending", o = {
                    resolve: n,
                    reject: r,
                    notify: i
                }, s = {
        ...
        M.support = function() {
            ...
            g.attachEvent)
                for (h in {
                    ...
                    o[h + "Bubbles"] = m;
            return M(function() {
                var e, t, n, r, i, a = "position:absolute;top:0;left:0;width:1px;height:1px;margin:0;", s = "visibility:hidden;border:0;";
        ...
        M.extend({
            ...
            data: function(e, n, r, i) {
                if (M.acceptData(e)) {
                    M.expando;
                    var a, o, s, l = "string" == typeof n, c = e.nodeType, u = c ? M.cache : e, d = c ? e[M.expando] : e[M.expando] && M.expando, f = "events" === n;
                ...
                if (M.acceptData(e)) {
                    ...
                    if (l[c]) {
                        if (t && (r = n ? l[c] : l[c].data)) {
                            for ((a = 0,
                            o = (t = M.isArray(t) ? t : t in r ? [t] : (t = M.camelCase(t))in r ? [t] : t.split(" ")).length)
                                ; a < o; a++)
                                    delete r[t[a]];
            ...
            var z, P, B, U = /[\n\t\r]/g, W = /\s+/, $ = /\r/g, X = /^(?:button|input)$/i, V = /^(?:button|input|object|select|textarea)$/i, Y = /^a(?:rea)?$/i, Z = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, K = M.support.getSetAttribute;
            M.fn.extend({
                attr: function(e, t) {
            ...
            M.event = {
                ...
                dispatch: function(n) {
                    ...
                    var r, i, a, o, s, l, c, u, d, f, p = (M._data(this, "events") || {})[n.type] || [], h = p.delegateCount, m = [].slice.call(arguments, 0), g = !n.exclusive && !n.namespace, v = (M.event.special[n.type] || {}).handle, y = [];
                    if (m[0] = n,
                ...
                fix: function(e) {
                    if (e[M.expando])
                        return e;
                    var n, r, i = e, a = M.event.fixHooks[e.type] || {}, o = a.props ? this.props.concat(a.props) : this.props;
                    for (e = M.Event(i),
                    n = o.length; n; )
                        e[r = o[--n]] = i[r];
            ...
            var je, Ne, Ae, De = /alpha\([^)]*\)/i, Oe = /opacity=([^)]*)/, Le = /([A-Z]|^ms)/g, Fe = /^-?\d+(?:px)?$/i, Me = /^-?\d/, qe = /^([\-+])=([\-+.\de]+)/, Re = {
                position: "absolute",
                visibility: "hidden",
                display: "block"
            ...
            var ze, Pe, Be = /%20/g, Ue = /\[\]$/, We = /\r?\n/g, $e = /#.*$/, Xe = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Ve = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, Ye = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Ze = /^(?:GET|HEAD)$/, Ke = /^\/\//, Ge = /\?/, Je = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Qe = /^(?:select|textarea)/i, et = /\s+/, tt = /([?&])_=[^&]*/, nt = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, rt = M.fn.load, it = {}, at = {}, ot = ["*/"] + ["*"];
            try {
                ze = F.href
            } catch (e) {
            ...
            M.extend({
                ...
                ajax: function(e, n) {
                    ...
                    e = t),
                    n = n || {};
                    var i, a, o, s, l, c, u, d, f = M.ajaxSetup({}, n), p = f.context || f, h = p !== f && (p.nodeType || p instanceof M) ? M(p) : M.event, m = M.Deferred(), g = M.Callbacks("once memory"), v = f.statusCode || {}, y = {}, b = {}, w = 0, T = {
                        readyState: 0,
            ...
            M.ajaxPrefilter("json jsonp", function(t, n, r) {
                ...
                if ("jsonp" === t.dataTypes[0] || !1 !== t.jsonp && (lt.test(t.url) || i && lt.test(t.data))) {
                    var a, o = t.jsonpCallback = M.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s = e[o], l = t.url, c = t.data, u = "$1" + o + "$2";
            ...
            var ft, pt, ht, mt, gt = {}, vt = /^(?:toggle|show|hide)$/, yt = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, bt = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
            M.fn.extend({
                show: function(e, t, n) {
                    var r, i;
                    if (e || 0 === e)
                ...
                animate: function(e, t, n, r) {
                    function i() {
                        ...
                        var t, n, r, i, o, s, l, c, u, d = M.extend({}, a), f = 1 === this.nodeType, p = f && M(this).is(":hidden");
